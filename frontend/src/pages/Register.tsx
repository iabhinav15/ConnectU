                ...
                <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center '>
                    ...
                    <form className='py-4 flex flex-col gap-2' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='w-full flex flex-col lg:flex-row gap-1 md:gap-2'>
                            ...
                            <div className='relative flex items-center gap-2'>
                                <TextInput
                                    name='cPassword' placeholder='Password' type={isPasswordVisible ? 'text' : 'password'}
                                    label='Confirm Password' register={register('cPassword', {
                                        validate: (value: any) => {
                                            const { password } = getValues();
                                            if (password !== value) return 'Passwords do not match!';
                                        }
                                    })}
                                    error={errors.cPassword && errors.cPassword.type === 'validate' ? (errors.cPassword?.message as string) : ''}
                                    styles='w-full'
                                />
                                <button
                                    type='button'
